...
extension AnalyticsFeatureRecoveryAppeared {
  ...
  static func trackFeatureRecoveryAppeared(product:Product?,  secondsSinceLeftApp:Int,  abTestColor:String,  abTestHeadline:String,  abTestButton:String ) {
...
extension AnalyticsFeatureRecoveryEmailPrompt {
  ...
  static func trackFeatureRecoveryEmailPrompt(product:Product? ) {
