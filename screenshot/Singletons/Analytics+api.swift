...
// created on: Sun Jun  3 10:53:18 IDT 2018
// created from: errorEventsForBurrow -  - b8ac69b 
...
typealias AnalyticsDevBurrowErrorSelectedShoppable = Analytics
extension AnalyticsDevBurrowErrorSelectedShoppable {
    
  static func trackDevBurrowErrorSelectedShoppable(productImageUrl:String,  selectedShoppableLabel:String,  otherLabels:String? ) {
      let key = "dev-burrow-error-selectedShoppable"
      var properties:[String:Any] = [:]
      properties["productImageUrl"] = productImageUrl
