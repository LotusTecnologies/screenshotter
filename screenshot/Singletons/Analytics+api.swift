...
// created on: Thu Jun 14 09:22:44 IDT 2018
// created from: june14 -  - e52dad1 
...
extension AnalyticsScreenshotDeleted {
  ...
  static func trackScreenshotDeleted(screenshot:Screenshot? ) {
...
extension AnalyticsScreenshotDeletedAll {
  ...
  static func trackScreenshotDeletedAll(amountJustDeeleted:Int ) {
      let key = "screenshot-deletedAll"
      var properties:[String:Any] = [:]
      properties["amountJustDeeleted"] = NSNumber.init(value: amountJustDeeleted)
