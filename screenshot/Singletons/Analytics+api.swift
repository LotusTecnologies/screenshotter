...
// created on: Tue Jun 12 09:00:36 IDT 2018
// created from: master -  - b16bab6 
...
typealias AnalyticsProductRelatedLooksLoaded = Analytics
extension AnalyticsProductRelatedLooksLoaded {
    
  static func trackProductRelatedLooksLoaded(shoppable:Shoppable? ) {
      let key = "product-relatedLooks-loaded"
      var properties:[String:Any] = [:]
      if let shoppable = shoppable {
          propertiesFor(shoppable).forEach { properties[$0] = $1 }
      }
