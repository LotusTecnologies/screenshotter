...
// created on: Sun May 27 08:50:31 IDT 2018
// created from: shareEvents -  - bdf9d30 
...
extension AnalyticsShareError {
  enum AnalyticsShareErrorPage : String{
    case `screenshotList` = "screenshotList"
    case `favorite` = "favorite"
    }
  ...
  static func trackShareError(screenshot:Screenshot?,  page:AnalyticsShareErrorPage,  errorTpye:AnalyticsShareErrorErrorTpye ) {
...
extension AnalyticsShareSocial {
  enum AnalyticsShareSocialPage : String{
    case `screenshotList` = "screenshotList"
    case `favorite` = "favorite"
    }
    
  static func trackShareSocial(screenshot:Screenshot?,  page:AnalyticsShareSocialPage ) {
...
extension AnalyticsSharedScreenshotStarted {
  enum AnalyticsSharedScreenshotStartedPage : String{
    case `screenshotList` = "screenshotList"
    case `favorite` = "favorite"
    }
    
  static func trackSharedScreenshotStarted(screenshot:Screenshot?,  page:AnalyticsSharedScreenshotStartedPage ) {
