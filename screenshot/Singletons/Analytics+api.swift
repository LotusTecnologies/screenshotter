...
// created on: Mon May  7 09:54:36 IDT 2018
// created from: master -  - 479d0c0 
...
extension AnalyticsCartCreditCardAdded {
  ...
  static func trackCartCreditCardAdded(cart:Cart?,  source:AnalyticsCartCreditCardAddedSource ) {
      ...
      AnalyticsTrackers.autoGeneratedCodeApi.appsee.track(key, properties: properties)
      AnalyticsTrackers.autoGeneratedCodeApi.segment.track(key, properties: properties)
      AnalyticsTrackers.autoGeneratedCodeApi.kochava.track(key, properties: properties)
  ...
  static func trackCartCvvCanceled(cart:Cart? ) {
      ...
      cart?.items?.forEach({ (i) in
            if let i = i as? CartItem {
                ...
                AnalyticsTrackers.autoGeneratedCodeApi.appsee.track(subItemKey, properties: properties)
                AnalyticsTrackers.autoGeneratedCodeApi.segment.track(subItemKey, properties: properties)
                AnalyticsTrackers.autoGeneratedCodeApi.kochava.track(subItemKey, properties: properties)
            }
      })
...
extension AnalyticsCartPurchaseCompleted {
  ...
  static func trackCartPurchaseCompleted(orderNumber:String,  cardEmail:String?,  cardFullName:String? ) {
...
extension AnalyticsCartShippingAdded {
  ...
  static func trackCartShippingAdded(cart:Cart?,  source:AnalyticsCartShippingAddedSource ) {
...
extension AnalyticsDevMemoryWarning {
  ...
  static func trackDevMemoryWarning(freeDiskSpace:String?,  totalDiskSpace:String?,  freeRam:String?,  usedRam:String? ) {
      let key = "dev-memoryWarning"
      var properties:[String:Any] = [:]
      if let freeDiskSpace = freeDiskSpace {
          properties["freeDiskSpace"] = freeDiskSpace
      }
      if let totalDiskSpace = totalDiskSpace {
          properties["totalDiskSpace"] = totalDiskSpace
      }
      if let freeRam = freeRam {
          properties["freeRam"] = freeRam
      }
      if let usedRam = usedRam {
          properties["usedRam"] = usedRam
      }
...
extension AnalyticsUserProperties {
  ...
  static func trackUserProperties(analyticsUser:AnalyticsUser? ) {
      ...
      AnalyticsTrackers.autoGeneratedCodeApi.segment.track(key, properties: properties)
      AnalyticsTrackers.autoGeneratedCodeApi.kochava.track(key, properties: properties)
      AnalyticsTrackers.autoGeneratedCodeApi.intercom.track(key, properties: properties)
...
extension AnalyticsFeatureScreenshotPreviewViewed {
  ...
  static func trackFeatureScreenshotPreviewViewed(screenshot:Screenshot? ) {
      let key = "feature-screenshotPreview-viewed"
      var properties:[String:Any] = [:]
...
extension AnalyticsShareDiscover {
  ...
  static func trackShareDiscover(screenshot:Screenshot? ) {
      ...
      AnalyticsTrackers.autoGeneratedCodeApi.segment.track(key, properties: properties)
      AnalyticsTrackers.autoGeneratedCodeApi.kochava.track(key, properties: properties)
      AnalyticsTrackers.autoGeneratedCodeApi.branch.track(key, properties: properties)
