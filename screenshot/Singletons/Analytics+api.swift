...
// created on: Mon May 28 16:42:09 IDT 2018
// created from: removeSDKs -  - 5cf8096 
...
extension AnalyticsCartPressedCheckout {
  ...
  static func trackCartPressedCheckout(cart:Cart? ) {
      ...
      if let value = properties["paymentInfoAvailable"] {
        fbProperties[FBSDKAppEventParameterNamePaymentInfoAvailable] = value
      }
...
extension AnalyticsSubmittedEmail {
  ...
  static func trackSubmittedEmail(email:String? ) {
      ...
      fbProperties[FBSDKAppEventParameterNameSuccess] = FBSDKAppEventParameterValueYes
       ...
       FBSDKAppEvents.logEvent(FBSDKAppEventNameCompletedRegistration, parameters: fbProperties)
