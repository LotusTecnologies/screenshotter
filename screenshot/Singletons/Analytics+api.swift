...
// created on: Wed May 16 09:22:21 IDT 2018
// created from: ignoreAdvertisingTrackingOptOut -  - 101e6d9 
...
extension AnalyticsUserProperties {
  ...
  static func trackUserProperties(analyticsUser:AnalyticsUser? ) {
      ...
      Analytics.debugShowLoggedAnalytics(eventName: key, properties: properties, destinations:["appsee", "segment", "kochava", "intercom", "intercom" ])
      //edit properties after sent them to supress complier warning if unused
      properties["_______"] = ""
...
extension AnalyticsMatchsticksFlagged {
  ...
  static func trackMatchsticksFlagged(matchstick:Matchstick?,  why:AnalyticsMatchsticksFlaggedWhy ) {
      ...
      AnalyticsTrackers.autoGeneratedCodeApi.kochava.track(key, properties: properties, sendEvenIfAdvertisingTrackingIsOptOut: true)
