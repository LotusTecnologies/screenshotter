...
class DiscoverScreenshotViewController : BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        passButton.titleLabel?.font = UIFont.hindMedium(forTextStyle: .subheadline, staticSize: true)
        ...
        addButton.titleLabel?.font = UIFont.hindMedium(forTextStyle: .subheadline, staticSize: true)
